...
export default function QuotationsPage() {
  ...
  const filteredData = quotationsData
    .filter((quotation) => {
      const matchesSearch =
            ...
            <tbody className='divide-y'>
              {currentItems.map((quotation) => (
                ...
                >
                  ...
                  <td className='px-4 py-3 align-middle'>
                    <div
                      className={`inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-medium ${getStatusColor(quotation.status)} text-white`}
                    >
