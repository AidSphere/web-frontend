 ...
 */
const SuccessPage = ({ type: propType }: { type: ('ACCOUNT_ACTIVATION' | 'EMAIL_VERIFICATION' | 'PASSWORD_RESET'); }) => {
  ...
  const config = {
    ACCOUNT_ACTIVATION: {
      ...
      description: 'Your email has been verified and your account is now active. You can now access the medical portal.',
      alertTitle: 'Account activated',
      alertMessage: 'Your medical practitioner account has been successfully activated. You now have full access to the AidSphere Medical Portal.',
    ...
    EMAIL_VERIFICATION: {
      ...
      description: 'Your email address has been successfully verified. Thank you for confirming your identity.',
      alertTitle: 'Email verification complete',
      alertMessage: 'Your email address is now verified. This helps ensure the security of your account and enables all communication features.',
    ...
    PASSWORD_RESET: {
      ...
      description: 'Your password has been successfully reset. You can now log in to your account with your new password.',
      alertTitle: 'Password updated',
      alertMessage: 'Your password has been successfully changed. Your account is now secure with the new credentials you provided.',
          ...
          <div className="space-y-4">
            <div className="rounded-lg border border-green-200 bg-green-50 p-4">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-green-800">{currentConfig.alertTitle}</h3>
            ...
            <Link 
              href={currentConfig.buttonRedirect}
              passHref
            >
              <Button 
                ...
                size="lg"
              >
                {currentConfig.buttonText} <FaArrowRight className="ml-2 size-4" />
              </Button>
            </Link>
            
            <div className="text-center text-sm text-foreground/70 mt-6">
              <p>{currentConfig.helpText}</p>
              <Link href={currentConfig.helpLinkHref} className="text-primary hover:text-primary-600 font-medium mt-1">
